"""
Django settings for tapBoxSite project.
...
SECRET_KEY = 'django-insecure-0jlpz^9n@m^wach41%=3$38ytd%g8vq%fq5&+(&kt6db+c*3!9'
...
INSTALLED_APPS = [
    'TapBoxMain.apps.MainpageConfig',  #BE SURE TO ADD ALL APPS TO HERE!
